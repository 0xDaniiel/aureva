        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="card-aureva">
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                <h2 className="text-xl font-heading font-medium text-foreground">Morning Routine</h2>
          ...
          <div className="card-aureva">
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                <h2 className="text-xl font-heading font-medium text-foreground">Night Routine</h2>
