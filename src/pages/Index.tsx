      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden">
        ...
        <div className="relative section-container pt-20">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-serif font-bold mt-4 leading-[1.1] text-foreground">
      ...
      <section className="section-padding">
        <div className="section-container grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <motion.div {...fadeUp}>
            ...
            <h2 className="text-3xl md:text-4xl font-serif font-bold mt-4 text-foreground">
