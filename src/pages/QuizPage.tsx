          ...
          <AnimatePresence mode="wait">
            {!result ? (
              ...
              >
                ...
                <h2 className="text-xl font-heading font-medium text-foreground mb-6">
              ...
              >
                ...
                <h2 className="text-3xl font-heading font-medium text-foreground mt-2">{skinResult?.title}</h2>
